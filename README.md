...
`doorDuck` показывает QR-пропуск для кампусов Школы 21 в приложении и виджетах на Android и iOS.
...
Краткая карта жизненного цикла QR, встроенных параметров и точек изменения: [как работает doorDuck](./docs/HOW_DOOR_DUCK_WORKS.md).
